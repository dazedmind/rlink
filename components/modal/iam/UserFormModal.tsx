...
export default function UserFormModal({
  ...
  /** Sends welcome email with temporary password via Resend + welcome-template. */
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (isEdit) {
        ...
        if (welcomeSent) {
          toast.success("User created. Welcome email with login details was sent.");
        } else {
          toast.warning(
            "User created, but the welcome email could not be sent. Share the password manually."
          );
        }
      }
      onSuccess();
