...
/** Employee welcome email with temporary password (same content as legacy welcome-template). */
export const WelcomeEmail = ({
  email,
  firstName,
  lastName,
  password,
  loginUrl = "https://your-portal-link.com/login",
}: WelcomeEmailProps) => (
  <Html>
    <Head />
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={securityNotice}>
          <strong>Security Tip:</strong> For your protection, you will be prompted to change
          this temporary password immediately after your first login.
        </Text>
        ...
        <Text style={footer}>
          ...
          <br />
          © 2026 R Land Development Inc. | Quezon City, Philippines
        </Text>
      </Container>
    </Body>
  </Html>
...
/** Block + horizontal margins center the image across common email clients. */
const logoImg = {
  display: "block",
  margin: "0 auto 8px",
};
